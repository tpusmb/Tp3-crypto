...
def read_image_set(img_secret_path, img_cover_path, size=(224, 224)):
    ...
    img_secret /= 255.
    img_cover /= 255.
    batch_cover = normalize_batch(np.array([img_cover]))
    batch_secret = normalize_batch(np.array([img_secret]))
